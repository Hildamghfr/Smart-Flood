...
document.getElementById('findRouteBtn').addEventListener('click', ()=>{
  ...
  routingControl.on('routesfound', e=>{
    ...
    // AUTO CLOSE SIDEBAR PADA TAMPILAN MOBILE SETELAH RUTE DITEMUKAN
...
/* =================================================================
   5. MOBILE SIDEBAR TOGGLE (DIPERBAIKI)
   ================================================================= */
...
function toggleSidebar(forceClose = false) {
  ...
  // Ubah icon tombol hamburger menjadi X saat terbuka
  menuToggle.innerHTML = sidebar.classList.contains('open') ? '✕' : '☰';
}

menuToggle.addEventListener('click', () => toggleSidebar());
map.on('click', () => toggleSidebar(true)); // Tutup menu saat tap peta